...
#pragma warning restore 0169
	...
	internal partial class WindowInvoker : Window {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='android.view']/class[@name='Window']/method[@name='invalidatePanelMenu' and count(parameter)=1 and parameter[1][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='android.view']/class[@name='Window']/method[@name='superDispatchGenericMotionEvent' and count(parameter)=1 and parameter[1][@type='android.view.MotionEvent']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='android.view']/class[@name='Window']/method[@name='superDispatchKeyShortcutEvent' and count(parameter)=1 and parameter[1][@type='android.view.KeyEvent']]"
