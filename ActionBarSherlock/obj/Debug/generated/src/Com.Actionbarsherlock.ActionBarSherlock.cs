...
namespace Com.Actionbarsherlock {
	...
	public abstract partial class ActionBarSherlock : global::Java.Lang.Object {
		...
		[Register ("com/actionbarsherlock/ActionBarSherlock$Implementation")]
		public abstract class Implementation {
			...
			// Metadata.xml XPath field reference: path="/api/package[@name='com.actionbarsherlock']/interface[@name='ActionBarSherlock.Implementation']/field[@name='DEFAULT_API']"
			[Register ("DEFAULT_API")]
			public const int DefaultApi = (int) -1;

			// Metadata.xml XPath field reference: path="/api/package[@name='com.actionbarsherlock']/interface[@name='ActionBarSherlock.Implementation']/field[@name='DEFAULT_DPI']"
		...
		[System.Obsolete ("Use the 'Implementation' type. This type will be removed in Mono for Android 5.0.")]
		public abstract class ImplementationConsts : Implementation {

			private ImplementationConsts ()
			{
			}
		}

		// Metadata.xml XPath interface reference: path="/api/package[@name='com.actionbarsherlock']/interface[@name='ActionBarSherlock.Implementation']"
		[Register ("com/actionbarsherlock/ActionBarSherlock$Implementation", "", "Com.Actionbarsherlock.ActionBarSherlock/IImplementationInvoker")]
		public partial interface IImplementation : global::Java.Lang.Annotation.IAnnotation {

			// Metadata.xml XPath method reference: path="/api/package[@name='com.actionbarsherlock']/interface[@name='ActionBarSherlock.Implementation']/method[@name='api' and count(parameter)=0]"
			[Register ("api", "()I", "GetApiHandler:Com.Actionbarsherlock.ActionBarSherlock/IImplementationInvoker, ActionBarSherlock")]
			int Api ();

			// Metadata.xml XPath method reference: path="/api/package[@name='com.actionbarsherlock']/interface[@name='ActionBarSherlock.Implementation']/method[@name='dpi' and count(parameter)=0]"
			[Register ("dpi", "()I", "GetDpiHandler:Com.Actionbarsherlock.ActionBarSherlock/IImplementationInvoker, ActionBarSherlock")]
			int Dpi ();

		}

		[global::Android.Runtime.Register ("com/actionbarsherlock/ActionBarSherlock$Implementation", DoNotGenerateAcw=true)]
		internal class IImplementationInvoker : global::Java.Lang.Object, IImplementation {

			static IntPtr java_class_ref = JNIEnv.FindClass ("com/actionbarsherlock/ActionBarSherlock$Implementation");
			IntPtr class_ref;

			public static IImplementation GetObject (IntPtr handle, JniHandleOwnership transfer)
			{
				return global::Java.Lang.Object.GetObject<IImplementation> (handle, transfer);
			}
			...
			static IntPtr Validate (IntPtr handle)
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
								JNIEnv.GetClassNameFromInstance (handle), "com.actionbarsherlock.ActionBarSherlock.Implementation"));
				return handle;
			}
			...
			public IImplementationInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
			{
			...
			protected override System.Type ThresholdType {
				get { return typeof (IImplementationInvoker); }
			}
...
#pragma warning disable 0169
			...
			{
				global::Com.Actionbarsherlock.ActionBarSherlock.IImplementation __this = global::Java.Lang.Object.GetObject<global::Com.Actionbarsherlock.ActionBarSherlock.IImplementation> (native__this, JniHandleOwnership.DoNotTransfer);
				return __this.Api ();
			}
